...
class App extends Component {
  ...
  onDeleteTrackItem = id => {
    ...
    const remainedTrackItems = tracksList.filter(
      eachTrackItem => eachTrackItem.id !== id,
    )
    this.setState({tracksList: remainedTrackItems})
  }
  ...
  render() {
    ...
    const tracksCount = filteredTracksList.length
    return (
      <>
        ...
        <div className="bottom-container">
          <div className="input-container">
            <h1 className="songs-play-list">Songs PlayList</h1>
